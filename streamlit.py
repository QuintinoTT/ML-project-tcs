...
with st.container(border=True): #fist query; price prediction
  ...
  if st.button("Estimate"):
    ...
    newframe = model.Dealwithinputdata(pd.DataFrame(data={"Rooms": [2], "Distance": [2], "Bedroom2": [2],"Bathroom": [2],"Car": [2],"Landsize":[2], "YearBuilt":[2], "PropertyCount": [2], "Type": ['h'], "Method": ["S"],   "CouncilArea": ["Yarra"], }))
    st.write(newframe)
