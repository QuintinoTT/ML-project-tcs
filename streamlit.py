...
if st.button("Budget stuff"):
  ...
  st.write(data.query("select Rooms, "+pricevarB+"-price as Budget_deviation, price FROM dataset  WHERE CouncilArea = \""+regionB+"\" order by ABS(Budget_deviation) LIMIT 15 "))
